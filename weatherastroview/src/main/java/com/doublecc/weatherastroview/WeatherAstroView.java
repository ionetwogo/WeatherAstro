package com.doublecc.weatherastroview;
...
public class WeatherAstroView extends View {
    ...
    public WeatherAstroView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        try {
            ...
            canvas.drawText("气压 " + pressure + "hpa", pressureTextRight, sunArcHeight + paintTextOffset, paint);
            // draw astor info
